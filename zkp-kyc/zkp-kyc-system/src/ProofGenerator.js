...
// //     constructor() {
// //         this.wasmPath = path.join(__dirname, "../build/Over18_js/Over18.wasm");
// //         this.zkeyPath = path.join(__dirname, "../build/Over18_final.zkey");
// //         this.vkeyPath = path.join(__dirname, "../build/verification_key.json");
// //         this.poseidon = null;
// //     }

// //     async init() {
// //         // Build Poseidon hash function once
// //         this.poseidon = await circomlibjs.buildPoseidon();
// //     }

// //     /**
// //      * Generate Poseidon hash for Aadhaar data
// //      */
// //     generateAadhaarHash(aadhaarNumber, birthYear, birthMonth, birthDay, salt) {
// //         if (!this.poseidon) {
// //             throw new Error("Poseidon not initialized. Call await proofGenerator.init()");
// //         }
// //         const inputs = [
...
// //                 salt: salt.toString(),
// //                 currentYear: currentDate.currentYear.toString(),
// //                 currentMonth: currentDate.currentMonth.toString(),
// //                 currentDay: currentDate.currentDay.toString(),
...
//         // ======================= THIS IS THE FIX =========================
//         // =================================================================
//         // The build artifacts are inside the 'build' directory.
...
//         // Circuit inputs MUST include all signals declared in Circom
//         const circuitInput = {
...
//         // Generate witness
//         const witness = await snarkjs.wtns.calculate(circuitInput, this.wasmPath);
