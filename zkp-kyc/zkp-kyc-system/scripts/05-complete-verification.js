...
//         console.log("👤 Alice generating ZK proof for age verification...");
...
//         // Alice's result
//         const [aliceCompleted, aliceResult] = await over18Verifier.connect(company).getVerificationResult(
//             requestData.alice.requestId
//         );
//         console.log(`Alice's verification: ${aliceCompleted ? 'Completed' : 'Pending'}, Result: ${aliceResult ? 'Over 18' : 'Under 18'}`);
        
//         // Bob's result  
//         const [bobCompleted, bobResult] = await over18Verifier.connect(company).getVerificationResult(
//             requestData.bob.requestId
//         );
...
//         console.log("\n📊 Summary:");
//         console.log("✅ Alice (25 years old) → Verified as Over 18");
//         console.log("❌ Bob (14 years old) → Verified as Under 18");
//         console.log("\n🔒 Privacy Preserved:");
//         console.log("• Aadhaar numbers were never revealed to the company");
//         console.log("• Exact birth dates were never revealed");
//         console.log("• Only the age verification result was shared");
